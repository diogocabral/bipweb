...
public class Especializacao implements Serializable {
	...
	private static final long serialVersionUID = 899688921515676972L;
	...
	public String toString() {
		return String.format("{Especializacao anoConclusao=[%s] anoInicio=[%s] codigoAgenciaFinanciadora=[%s] cargaHoraria=[%s] " +
				...
				"nomeOrientador=[%s] nomeInstituicao=[%s] nomeOrgao=[%s] sequenciaFormacao=[%s] statusCurso=[%s] tituloMonografia=[%s]}", 
				anoConclusao, anoInicio, codigoAgenciaFinanciadora, cargaHoraria, codigoCurso, codigoInstituicao, codigoOrgao, flagBolsa, 
				nivel, nomeAgencia, nomeCurso, nomeOrientador, nomeInstituicao, nomeOrgao, sequenciaFormacao, statusCurso, tituloMonografia);
	}
