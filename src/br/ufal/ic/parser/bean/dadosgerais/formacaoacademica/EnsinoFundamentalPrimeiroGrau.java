...
public class EnsinoFundamentalPrimeiroGrau implements Serializable {

	private static final long serialVersionUID = -5770594474269241295L;
	...
	public String toString() {
		return String.format("{EnsinoFundamentalPrimeiroGrau anoConclusao=[%s] anoInicio=[%s] codigoInstituicao=[%s] nivel=[%s] " +
