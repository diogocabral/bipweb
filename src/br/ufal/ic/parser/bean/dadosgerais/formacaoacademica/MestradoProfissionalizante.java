...
public class MestradoProfissionalizante implements Serializable {

	private static final long serialVersionUID = -5109822863877865818L;
	...
	public String toString() {
		return String.format("{MestradoProfissionalizante anoConclusao=[%s] anoInicio=[%s] anoObtencaoTitulo=[%s] " +
				"codigoAgenciaFinanciadora=[%s] codigoAreaCurso=[%s] codigoCurso=[%s] codigoCursoCapes=[%s] codigoInstituicao=[%s] " +
				"codigoOrgao=[%s] flagBolsa=[%s] nivel=[%s] nomeAgencia=[%s] nomeCompletoOrientador=[%s] nomeCurso=[%s] " +
				"nomeInstituicao=[%s] nomeOrgao=[%s] numeroIdOrientador=[%s] sequenciaFormacao=[%s] statusCurso=[%s] " +
				"tituloDissertacaoTese=[%s] palavrasChave=[%s] areasConhecimento=[%s] setoresAtividade=[%s]}", anoConclusao, anoInicio, 
				anoObtencaoTitulo, codigoAgenciaFinanciadora, codigoAreaCurso, codigoCurso, codigoCursoCapes, codigoInstituicao, codigoOrgao, 
				flagBolsa, nivel, nomeAgencia, nomeCompletoOrientador, nomeCurso, nomeInstituicao, nomeOrgao, numeroIdOrientador, 
				sequenciaFormacao, statusCurso, tituloDissertacaoTese, palavrasChave, areasConhecimento, setoresAtividade);
	}
