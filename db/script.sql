...
create table category (id bigint not null auto_increment, name varchar(255), description varchar(255), criteria varchar(255), parent_id bigint, owner_username varchar(255), primary key (id))
create table history (id bigint not null auto_increment, title varchar(255), url varchar(255), score float, feedbackScore float, user_username varchar(255), category_id bigint, primary key (id))
