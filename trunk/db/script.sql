...
create table category (id bigint not null auto_increment, name varchar(255), description varchar(255), criteria varchar(255), terms varchar(255), owner_username varchar(255), parent_id bigint, primary key (id))
